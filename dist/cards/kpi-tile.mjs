...
function KpiTile({
  ...
  if (href) {
    return /* @__PURE__ */ jsx(Link, { href, className: "block focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-indigo-400 rounded-lg", children: body });
  }
  return body;
}
function Sparkline({
