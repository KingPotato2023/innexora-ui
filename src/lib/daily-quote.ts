// lib/daily-quote.ts
//
// One inspirational quote per day, picked deterministically from a curated
// list. The same visitor sees the same quote all day and a fresh one
// overnight - same pattern as the zen image. Picking is index = day-of-year
// mod list-length, so over a year every quote surfaces 5-7 times.
